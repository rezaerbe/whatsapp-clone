package com.application.chaterbe.Adapter;
...
import com.application.chaterbe.Model.Messages;
import com.application.chaterbe.R;
...
public class MessageAdapter extends RecyclerView.Adapter<MessageAdapter.MessageViewHolder>{
    ...
    public void onBindViewHolder(@NonNull final MessageViewHolder messageViewHolder, int i)
    {
        ...
        messageViewHolder.timeReceiver.setVisibility(View.GONE);
        // messageViewHolder.receiverProfileImage.setVisibility(View.GONE);
        messageViewHolder.senderMessageText.setVisibility(View.GONE);
        messageViewHolder.timeSender.setVisibility(View.GONE);
        ...
        if (fromMessageType.equals("text"))
        {
            if (fromUserID.equals(messageSenderId))
            {
                ...
                messageViewHolder.senderMessageText.setText(messages.getMessage());
                messageViewHolder.timeSender.setText(messages.getTime() + " - " + messages.getDate());
            }
            else
            {
                ...
                messageViewHolder.receiverMessageText.setText(messages.getMessage());
                messageViewHolder.timeReceiver.setText(messages.getTime() + " - " + messages.getDate());
            }
        }
    }
